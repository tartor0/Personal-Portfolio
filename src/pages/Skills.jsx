    ...
    <div className="grid px-4 sm:px-10 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-6 mt-6">
      {skills.map((skill, idx) => {
        ...
        return (
          ...
          >
            <IconComponent className="text-orange-500 w-10 h-10 md:w-14 md:h-14" />
      ...
      <div className="flex justify-center gap-4 mb-8 flex-wrap">
        <button
          className={`flex items-center gap-2 px-5 py-3 rounded-full font-medium ${
            activeTab === "frontend" ? "bg-orange-500 text-white shadow-lg" : "bg-gray-800/40 text-gray-300 backdrop-blur-md"
          }`}
        ...
        <button
          className={`flex items-center gap-2 px-5 py-3 rounded-full font-medium ${
            activeTab === "backend" ? "bg-orange-500 text-white shadow-lg" : "bg-gray-800/40 text-gray-300 backdrop-blur-md"
          }`}
        ...
        <button
          className={`flex items-center gap-2 px-5 py-3 rounded-full font-medium ${
            activeTab === "tools" ? "bg-orange-500 text-white shadow-lg" : "bg-gray-800/40 text-gray-300 backdrop-blur-md"
          }`}
