...
export default function Contact({ id, className = "" }) {
  ...
  return (
    <div id={id} className={`${className} min-h-screen px-6 md:px-10 font-poppins-med text-white`}>
        ...
        <div className="flex flex-col md:flex-row gap-10" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 md:w-1/4 px-10">
            ...
            <div className="flex flex-col gap-3 text-xl">
              <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-500">
                <FaGithub /> GitHub
              </a>
              <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-500">
                <FaLinkedin /> LinkedIn
              </a>
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-500">
                <FaInstagram /> Instagram
              </a>
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-500">
                <FaTwitter /> Twitter
              </a>
            </div>
          </div>
      ...
      {activeTab === "support" && (
        <div className="flex flex-col md:flex-row items-center gap-10 justify-center mt-6" data-aos="fade-up" data-aos-delay="200">
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-xl font-semibold">Support Me</h2>
            <p className="text-gray-300 text-center md:text-left">Scan the QR code to patronize me.</p>
            <img
