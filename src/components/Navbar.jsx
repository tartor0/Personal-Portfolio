...
export default function Navbar() {
  ...
  return (
    <nav className="text-white py-5 px-5 md:px-10 font-poppins-med relative">
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-9 md:gap-3 lg:gap-40">
          <div className="flex gap-5 md:gap-8 items-center border-2 border-gray-400 py-4 px-5 rounded-full text-gray-300">
